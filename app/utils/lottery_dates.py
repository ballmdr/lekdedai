...
class LotteryDates:
    ...
    # วันที่หวยออกจริง (จาก GLO API)
    NORMAL_DRAW_DATES = [
        # 2567 (2024) - ข้อมูลจาก API จริง
        ...
        # 2568 (2025) - เฉพาะวันที่หวยออกแล้วเท่านั้น
    ...
    # วันที่หวยออกที่อาจเลื่อน (กรณีพิเศษ) - จาก GLO API จริง
    SPECIAL_DRAW_DATES = {
        "2024-01-17": "เลื่อนจาก 16 มกราคม 2024",
        "2024-05-02": "เลื่อนจาก 1 พฤษภาคม 2024", 
        "2025-01-02": "เลื่อนจาก 1 มกราคม 2025",
        "2025-01-17": "เลื่อนจาก 16 มกราคม 2025",
        "2025-05-02": "เลื่อนจาก 1 พฤษภาคม 2025",
    }
