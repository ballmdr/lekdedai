...
// ห่อด้วย IIFE เพื่อโหลดซ้ำแล้วไม่เกิด "Identifier has already been declared"
(function () {
    'use strict';
    ...
    // Add custom loading animation styles (ครั้งเดียวต่อหน้า)
    function addLoadingStyles() {
        if (document.getElementById('theme-loading-styles')) {
            return;
        }
        const style = document.createElement('style');
        style.id = 'theme-loading-styles';
        style.textContent = `
        .animate-spin {
    ...
    // Export for global access (ทับค่าเดิมได้ ไม่ throw)
